...
namespace Unicorn.Toolbox
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void VisualizeStatistics()
        {
            ...
            var vizData = GetVisualizationData(filter);
        ...
        private IOrderedEnumerable<KeyValuePair<string, int>> GetVisualizationData(FilterType filterType)
        {
            var data = StatisticsView.analyzer.Data;
